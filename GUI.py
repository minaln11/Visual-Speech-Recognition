...
WEIGHTS_PATH = os.path.join(CURRENT_PATH,'lipweight.h5')
...
class App:
    def __init__(self, window, window_title, video_source=0):
        ...
        self.btn_upload = tkinter.Button(window, text="Upload", width=10, command=self.upload, bg="red")
        self.btn_upload.pack(side="top")

        self.btn_caption = tkinter.Button(window, text="Predict", width=10, command=self.caption,bg="green")
